...
<body>
    ...
    <table>
        ...
        <tbody>
            <tr><td>Gross Salary</td><td style="text-align:right;">${{ number_format($payroll->gross_salary, 2) }}</td></tr>
            <tr><td>Deductions</td><td style="text-align:right;">-${{ number_format($payroll->deductions, 2) }}</td></tr>
            <tr class="grand"><td>Net Pay</td><td style="text-align:right;">${{ number_format($payroll->net_salary, 2) }}</td></tr>
        </tbody>
    </table>
