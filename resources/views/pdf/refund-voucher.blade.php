...
<body>
        ...
        <tr>
            ...
            <td style="width: 45%;">
                ...
                <table class="no-border meta-row" style="margin-top: 10px;">
                    <tr><td class="meta-label">Refund Voucher #</td><td class="meta-value">{{ $adjustment->document_number }}</td></tr>
    ...
    <p class="note">This voucher confirms {{ $adjustment->money() }} was refunded against Invoice {{ $invoice->invoice_number }}, paid out separately from the amounts recorded as received against it.</p>
