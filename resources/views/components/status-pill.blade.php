...
@php
    $map = [
        ...
        'credit_note' => 'bg-amber-400/15 text-amber-300 border-amber-400/20',
        'refunded' => 'bg-rose-400/15 text-rose-300 border-rose-400/20',
        'written_off' => 'bg-rose-400/15 text-rose-300 border-rose-400/20',
        ...
        'converted' => 'bg-emerald-400/15 text-emerald-300 border-emerald-400/20',
    ];
