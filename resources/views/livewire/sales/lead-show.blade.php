        ...
        <div class="space-y-6 lg:col-span-2">
            <div class="glass-card">
                ...
                <dl class="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div><dt class="text-white/40">Service Type</dt><dd class="mt-0.5 text-white">{{ ucwords(str_replace('_', ' ', $lead->service_type)) }}</dd></div>
                    ...
                    <div><dt class="text-white/40">Sales Person</dt><dd class="mt-0.5 text-white">{{ $lead->salesPerson->name }}</dd></div>
                </dl>
        ...
        <div class="space-y-6">
            <div class="glass-card">
                ...
                <select wire:model="status" class="input-glass">
                    @foreach (['new', 'contacted', 'proposal_sent', 'negotiation', 'won', 'lost'] as $s)
