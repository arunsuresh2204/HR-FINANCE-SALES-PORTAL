...
class FeatureCatalog
{
    ...
    public const FEATURE_DESCRIPTIONS = [
        ...
        'access_sales_leads' => 'Leads pipeline (add/track cold-outreach contacts); sales managers with this also see their team\'s leads',
        'access_sales_clients' => 'Client list and client detail pages; sales managers with this also see their team\'s clients',
        'access_sales_targets' => 'Sales targets dashboard and reports; sales managers with this set and review their team\'s targets',
